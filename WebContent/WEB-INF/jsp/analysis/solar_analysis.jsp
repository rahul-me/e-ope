						...
						<div class="col-md-12">
							<div class="portlet box blue customPanel">
								<div class="portlet-title customPanel-title">
									<div class="caption font-sm">Solar Source</div>
									<div class="tools">
										
									</div>
								</div>
								<div class="portlet-body" id="solar-body" style="padding: 0px;">
									<jsp:include page="../components/solar_detail_chart.jsp"></jsp:include>																		
								</div>
							</div>
						</div>
					</div>
...
$('#solar-body').css('height',height-220);	 
$("#solar_detail_chart").css('height',height-220);

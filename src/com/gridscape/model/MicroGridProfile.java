...
@Entity
@Table(name="microgrid_profile")
public class MicroGridProfile extends BaseEntity{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5354237175986776791L;
	...
	public String toString() {
		return "MicroGridProfile [microgrid_id=" + microgrid_id
				+ ", start_time=" + start_time + ", end_time=" + end_time
				+ ", lng_start_time=" + lng_start_time + ", lng_end_time="
				+ lng_end_time + ", battery_low_threshold="
				+ battery_low_threshold + ", battery_charge_source="
				+ battery_charge_source + ", standard_situation="
				+ standard_situation + ", critical_situation="
				+ critical_situation + ", battery_low=" + battery_low
				+ ", solar_low=" + solar_low + "]";
	}
